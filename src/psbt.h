...
#ifndef COYOTECOIN_PSBT_H
#define COYOTECOIN_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Coyotecoin transaction.) Returns true if the merge succeeded, false otherwise. */

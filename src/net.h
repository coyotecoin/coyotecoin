...
#ifndef COYOTECOIN_NET_H
#define COYOTECOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/coyotecoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Coyotecoin’s Peer-to-Peer Network")

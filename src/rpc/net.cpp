...
static RPCHelpMan addnode()
{
    return RPCHelpMan{"addnode",
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("addnode", "\"192.168.1.8:9999\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.1.8:9999\", \"onetry\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan addconnection()
{
    return RPCHelpMan{"addconnection",
        ...
        RPCExamples{
            HelpExampleCli("addconnection", "\"192.168.1.8:9999\" \"outbound-full-relay\"")
            + HelpExampleRpc("addconnection", "\"192.168.1.8:9999\" \"outbound-full-relay\"")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan disconnectnode()
{
    return RPCHelpMan{"disconnectnode",
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"192.168.1.8:9999\"")
            + HelpExampleCli("disconnectnode", "\"\" 1")
            + HelpExampleRpc("disconnectnode", "\"192.168.1.8:9999\"")
...
static RPCHelpMan setban()
{
    return RPCHelpMan{"setban",
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("setban", "\"192.168.1.8\" \"add\" 86400")
                            + HelpExampleCli("setban", "\"192.168.1.0/24\" \"add\"")
                            + HelpExampleRpc("setban", "\"192.168.1.8\", \"add\", 86400")
                },
